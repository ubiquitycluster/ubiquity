# Hajimari
Hajimari is a simplistically beautiful startpage designed to be the entrypoint for your Ubiquity cluster.
...
- Web and app search with customisable search providers
...
- Customisable list of bookmarks
...
Simply copy this helm chart into your cluster and ArgoCD will install it.

To disable? Simply move to the "disabled/apps" folder.
...
Hajimari supports the following configuration options that can be modified by editing the `values.yaml`.
