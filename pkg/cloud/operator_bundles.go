...
func RequiredCloudOperatorBundles() []CloudOperatorBundle {
	return []CloudOperatorBundle{
		...
		{Name: "k8up-restore", Controller: "K8up Operator", OwnedCRD: "restores.k8up.io", InstallNamespace: "k8up-system", Source: "https://github.com/k8up-io/k8up", Version: "pinned-by-platform", AirgapArtifact: "platform/vendor/k8up"},
