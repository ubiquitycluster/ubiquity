...
OR:
- Enable IPMI and network boot
- Use UEFI mode and disable CSM (legacy) mode - This is UEFI-only. The standard has been around for _10 years_ - Ditch Legacy boot!
- Disable secure boot
...
- [ ] Choose an external IP address for each machine
- [ ] Choose the authentication mechanism (LDAP, etc)
