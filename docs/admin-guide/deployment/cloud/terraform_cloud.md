...
This document explains how to use Ubiquity with Terraform Cloud.
...
2. In this git repository, add a copy of the Ubiquity example `main.tf`
...
Ubiquity in combination with Terraform Cloud (TFE) can be configured to give
...
If after enabling autoscaling with Terraform Cloud for your Ubiquity cluster,
