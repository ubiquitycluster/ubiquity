...
Good enough for standard usage, and secure.
...
- [x] Initialise GitOps repository on Gitea automatically
- [x] Observability
    - [x] Monitoring
    - [x] Logging
    - [ ] Alerting
...
- [x] Fully _automatic_, not just _automated_
...
- [ ] Additional applications
    ...
    - [ ] Slurm
    - [ ] Onyxia
    - [ ] [Development dashboard](https://github.com/cjcshadowsan/ubiquity-backstage)
...
- [ ] Cluster API ([last attempt](https://github.com/cjcshadowsan/ubiquity/pull/2))
